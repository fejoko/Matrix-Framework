...
void matrix_logger_init(Matrix_Engine* const engine, Matrix_Application* const application, Matrix_Time* const time, Matrix_Logger* const logger);
...
#ifdef ___MTRX_NOLOG
#define MTRX_CORE_PRELOG(message, level, application)
#define MTRX_CORE_LOG(message, level, logger)
#else
#define MTRX_CORE_PRELOG(message, level, application) \
matrix_logger_core_prelog(message, level, application)
#define MTRX_CORE_LOG(message, level, logger) \
